...
public class ToolModifierMenu extends AbstractContainerMenu {

    protected ToolModifierBlockEntity blockEntity;
    protected Level level;
    protected ContainerData data;
    protected Player player;
    protected BlockPos blockPos;

    public ToolModifierMenu(int containerID, Inventory inventory, FriendlyByteBuf extraData) {
        this(containerID, inventory, extraData.readBlockPos(), new SimpleContainerData(2));

    }

    public ToolModifierMenu(int containerID, Inventory inventory, BlockPos blockPos, ContainerData data) {
        super(ModMenuTypes.TOOL_MODIFIER_MENU.get(), containerID);
        this.player = inventory.player;
        this.blockPos = blockPos;
        this.level = inventory.player.level();
        this.data = data;
        this.blockEntity = (ToolModifierBlockEntity) this.level.getBlockEntity(blockPos);
        ...
        this.addSlot(new ModResultSlot(blockEntity.getItemStackHandler(), 2, 134, 36));
    ...
    public boolean stillValid(@NotNull Player player) {
        ...
        return stillValid(ContainerLevelAccess.create(player.level(), blockPos),
                player, ModBlocks.TOOL_MODIFIER.get());
    }

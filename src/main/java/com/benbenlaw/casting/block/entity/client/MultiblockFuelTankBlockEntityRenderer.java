...
public class MultiblockFuelTankBlockEntityRenderer implements BlockEntityRenderer<MultiblockFuelTankBlockEntity> {

    public MultiblockFuelTankBlockEntityRenderer(BlockEntityRendererProvider.Context context) {
    }

    @Override
    public void render(MultiblockFuelTankBlockEntity entity, float pPartialTick, PoseStack pPoseStack,
                       MultiBufferSource pBufferSource, int pPackedLight, int pPackedOverlay) {

        FluidTank fluidTank = entity.fluidHandler;

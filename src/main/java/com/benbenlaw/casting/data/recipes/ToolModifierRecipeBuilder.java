...
public class ToolModifierRecipeBuilder implements RecipeBuilder {
    ...
    public ToolModifierRecipeBuilder(SizedIngredient upgradeItem, FluidStack upgradeFluid, String effect) {
    ...
    public static ToolModifierRecipeBuilder ToolModifierRecipesBuilder(SizedIngredient upgradeItem, FluidStack upgradeFluid, String effect) {
        return new ToolModifierRecipeBuilder(upgradeItem, upgradeFluid, effect);
    }
    ...
    public void save(@NotNull RecipeOutput recipeOutput, @NotNull ResourceLocation id) {
        ...
        ToolModifierRecipe solidifierRecipe = new ToolModifierRecipe(this.upgradeItem, this.upgradeFluid, this.effect);
